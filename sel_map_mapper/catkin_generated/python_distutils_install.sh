...
echo_and_run cd "/home/firefly/ROAHM/sel_map_ws/src/sel_map/sel_map_mapper"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/firefly/ROAHM/sel_map_ws/src/sel_map/sel_map_mapper/setup.py" \
     \
    build --build-base "/home/firefly/ROAHM/sel_map_ws/src/sel_map/sel_map_mapper" \
    install \
    --root="${DESTDIR-/}" \
